...
CreateThread(function()
  ...
  while true do
    ...
    for k, loc in pairs(Config.Locations.cutting) do
    ...
    for _, loc in pairs(Config.Locations.packing) do
      local coords = loc.coords
      local dist = Vdist(plyCoords.x, plyCoords.y, plyCoords.z, coords.x, coords.y, coords.z)
      if dist <= 25.0 then
        DrawMarker(27, coords.x, coords.y, coords.z - 0.97, 0, 0, 0, 0, 0, 0, 0.90, 0.90, 0.90, 255,
...
CreateThread(function()
  while true do
    ...
    if dist <= 20.0 then
      DrawMarker(0, dCoords.x, dCoords.y, dCoords.z - 0.96, 0, 0, 0, 0, 0, 0, 2.20, 2.20, 2.20, 255, 255, 255, 200, 0, 0,
        0, 0)
    else
      Wait(1000)
    end
